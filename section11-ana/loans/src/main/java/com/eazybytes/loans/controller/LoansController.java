...
public class LoansController {
    ...
    @Operation(
            ...
            description = "Get build info for loans microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Get Java version that is running loans microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Get Contact info of loan microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
